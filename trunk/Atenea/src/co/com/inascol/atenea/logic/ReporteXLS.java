...
public class ReporteXLS {
	...
	public Boolean generarReporteUpme(GppPersona persona){
	...
	public Boolean generarReporteIngeominas(GppPersona persona){
		estadoOperacion = false;
		try{
			simpleDateFormat = new SimpleDateFormat("yyyy/MM/dd");
			HSSFWorkbook libro = new HSSFWorkbook();
	...
	public Boolean generarReporteFUHV(GppPersona persona){
		estadoOperacion = false;
		try{
			HSSFWorkbook libro = new HSSFWorkbook();
			...
			if(persona.getGppPerfilprofesional()!=null){
				...
				if(perfil.getIdiNididioma1()!=null && perfil.getIdiNididioma1()>0)
					idioma1 = idiomaService.buscarPorIdIdioma(perfil.getIdiNididioma1());
				if(perfil.getIdiNididioma2()!=null && perfil.getIdiNididioma2()>0)
